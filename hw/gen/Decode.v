...
module Decode (
  input               flush,
  input               stall,
  input               dec_src_0_valid,
  output              dec_src_0_ready,
  input      [31:0]   dec_src_0_pc,
  input      [31:0]   dec_src_0_branch_pc,
  input               dec_src_0_branch_taken,
  input      [31:0]   dec_src_0_instr,
  input               dec_src_1_valid,
  output              dec_src_1_ready,
  input      [31:0]   dec_src_1_pc,
  input      [31:0]   dec_src_1_branch_pc,
  input               dec_src_1_branch_taken,
  input      [31:0]   dec_src_1_instr,
  output              dec_dst_0_valid,
  input               dec_dst_0_ready,
  output              dec_dst_0_micro_op_uop_com_rd_wen,
  output              dec_dst_0_micro_op_uop_com_src2_is_imm,
  output     [4:0]    dec_dst_0_micro_op_uop_alu_alu_ctrl_op,
  output              dec_dst_0_micro_op_uop_alu_alu_is_word,
  output     [3:0]    dec_dst_0_micro_op_uop_bju_bju_ctrl_op,
  output              dec_dst_0_micro_op_uop_bju_bju_rd_eq_rs1,
  output              dec_dst_0_micro_op_uop_bju_bju_rd_is_link,
  output              dec_dst_0_micro_op_uop_bju_bju_rs1_is_link,
  output     [3:0]    dec_dst_0_micro_op_uop_bju_exp_ctrl_op,
  output     [11:0]   dec_dst_0_micro_op_uop_bju_exp_csr_addr,
  output              dec_dst_0_micro_op_uop_bju_exp_csr_wen,
  output     [3:0]    dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op,
  output              dec_dst_0_micro_op_uop_lsu_lsu_is_load,
  output              dec_dst_0_micro_op_uop_lsu_lsu_is_store,
  output     [2:0]    dec_dst_0_exe_sel,
  output     [4:0]    dec_dst_0_rs1_addr,
  output     [4:0]    dec_dst_0_rs2_addr,
  output     [4:0]    dec_dst_0_rd_addr,
  output     [63:0]   dec_dst_0_imm,
  output     [31:0]   dec_dst_0_pc,
  output     [31:0]   dec_dst_0_branch_pc,
  output              dec_dst_0_branch_taken,
  output     [31:0]   dec_dst_0_instr,
  output              dec_dst_1_valid,
  input               dec_dst_1_ready,
  output              dec_dst_1_micro_op_uop_com_rd_wen,
  output              dec_dst_1_micro_op_uop_com_src2_is_imm,
  output     [4:0]    dec_dst_1_micro_op_uop_alu_alu_ctrl_op,
  output              dec_dst_1_micro_op_uop_alu_alu_is_word,
  output     [3:0]    dec_dst_1_micro_op_uop_bju_bju_ctrl_op,
  output              dec_dst_1_micro_op_uop_bju_bju_rd_eq_rs1,
  output              dec_dst_1_micro_op_uop_bju_bju_rd_is_link,
  output              dec_dst_1_micro_op_uop_bju_bju_rs1_is_link,
  output     [3:0]    dec_dst_1_micro_op_uop_bju_exp_ctrl_op,
  output     [11:0]   dec_dst_1_micro_op_uop_bju_exp_csr_addr,
  output              dec_dst_1_micro_op_uop_bju_exp_csr_wen,
  output     [3:0]    dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op,
  output              dec_dst_1_micro_op_uop_lsu_lsu_is_load,
  output              dec_dst_1_micro_op_uop_lsu_lsu_is_store,
  output     [2:0]    dec_dst_1_exe_sel,
  output     [4:0]    dec_dst_1_rs1_addr,
  output     [4:0]    dec_dst_1_rs2_addr,
  output     [4:0]    dec_dst_1_rd_addr,
  output     [63:0]   dec_dst_1_imm,
  output     [31:0]   dec_dst_1_pc,
  output     [31:0]   dec_dst_1_branch_pc,
  output              dec_dst_1_branch_taken,
  output     [31:0]   dec_dst_1_instr
);
  ...
  wire       [4:0]    decode_comb_0_rs1_addr;
  wire       [4:0]    decode_comb_0_rs2_addr;
  wire       [4:0]    decode_comb_0_rd_addr;
  wire       [63:0]   decode_comb_0_imm;
  wire                decode_comb_0_micro_op_uop_com_rd_wen;
  wire                decode_comb_0_micro_op_uop_com_src2_is_imm;
  wire       [4:0]    decode_comb_0_micro_op_uop_alu_alu_ctrl_op;
  wire                decode_comb_0_micro_op_uop_alu_alu_is_word;
  wire       [3:0]    decode_comb_0_micro_op_uop_bju_bju_ctrl_op;
  wire                decode_comb_0_micro_op_uop_bju_bju_rd_eq_rs1;
  wire                decode_comb_0_micro_op_uop_bju_bju_rd_is_link;
  wire                decode_comb_0_micro_op_uop_bju_bju_rs1_is_link;
  wire       [3:0]    decode_comb_0_micro_op_uop_bju_exp_ctrl_op;
  wire       [11:0]   decode_comb_0_micro_op_uop_bju_exp_csr_addr;
  wire                decode_comb_0_micro_op_uop_bju_exp_csr_wen;
  wire       [3:0]    decode_comb_0_micro_op_uop_lsu_lsu_ctrl_op;
  wire                decode_comb_0_micro_op_uop_lsu_lsu_is_load;
  wire                decode_comb_0_micro_op_uop_lsu_lsu_is_store;
  wire       [2:0]    decode_comb_0_exe_sel;
  wire       [4:0]    decode_comb_1_rs1_addr;
  wire       [4:0]    decode_comb_1_rs2_addr;
  wire       [4:0]    decode_comb_1_rd_addr;
  wire       [63:0]   decode_comb_1_imm;
  wire                decode_comb_1_micro_op_uop_com_rd_wen;
  wire                decode_comb_1_micro_op_uop_com_src2_is_imm;
  wire       [4:0]    decode_comb_1_micro_op_uop_alu_alu_ctrl_op;
  wire                decode_comb_1_micro_op_uop_alu_alu_is_word;
  wire       [3:0]    decode_comb_1_micro_op_uop_bju_bju_ctrl_op;
  wire                decode_comb_1_micro_op_uop_bju_bju_rd_eq_rs1;
  wire                decode_comb_1_micro_op_uop_bju_bju_rd_is_link;
  wire                decode_comb_1_micro_op_uop_bju_bju_rs1_is_link;
  wire       [3:0]    decode_comb_1_micro_op_uop_bju_exp_ctrl_op;
  wire       [11:0]   decode_comb_1_micro_op_uop_bju_exp_csr_addr;
  wire                decode_comb_1_micro_op_uop_bju_exp_csr_wen;
  wire       [3:0]    decode_comb_1_micro_op_uop_lsu_lsu_ctrl_op;
  wire                decode_comb_1_micro_op_uop_lsu_lsu_is_load;
  wire                decode_comb_1_micro_op_uop_lsu_lsu_is_store;
  wire       [2:0]    decode_comb_1_exe_sel;
  ...
  wire       [31:0]   src_stream_1_instr;
  wire                dst_stream_0_valid;
  wire                dst_stream_0_ready;
  wire                dst_stream_0_micro_op_uop_com_rd_wen;
  wire                dst_stream_0_micro_op_uop_com_src2_is_imm;
  wire       [4:0]    dst_stream_0_micro_op_uop_alu_alu_ctrl_op;
  wire                dst_stream_0_micro_op_uop_alu_alu_is_word;
  wire       [3:0]    dst_stream_0_micro_op_uop_bju_bju_ctrl_op;
  wire                dst_stream_0_micro_op_uop_bju_bju_rd_eq_rs1;
  wire                dst_stream_0_micro_op_uop_bju_bju_rd_is_link;
  wire                dst_stream_0_micro_op_uop_bju_bju_rs1_is_link;
  wire       [3:0]    dst_stream_0_micro_op_uop_bju_exp_ctrl_op;
  wire       [11:0]   dst_stream_0_micro_op_uop_bju_exp_csr_addr;
  wire                dst_stream_0_micro_op_uop_bju_exp_csr_wen;
  wire       [3:0]    dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op;
  wire                dst_stream_0_micro_op_uop_lsu_lsu_is_load;
  wire                dst_stream_0_micro_op_uop_lsu_lsu_is_store;
  wire       [2:0]    dst_stream_0_exe_sel;
  wire       [4:0]    dst_stream_0_rs1_addr;
  wire       [4:0]    dst_stream_0_rs2_addr;
  wire       [4:0]    dst_stream_0_rd_addr;
  wire       [63:0]   dst_stream_0_imm;
  wire       [31:0]   dst_stream_0_pc;
  wire       [31:0]   dst_stream_0_branch_pc;
  wire                dst_stream_0_branch_taken;
  wire       [31:0]   dst_stream_0_instr;
  wire                dst_stream_1_valid;
  wire                dst_stream_1_ready;
  wire                dst_stream_1_micro_op_uop_com_rd_wen;
  wire                dst_stream_1_micro_op_uop_com_src2_is_imm;
  wire       [4:0]    dst_stream_1_micro_op_uop_alu_alu_ctrl_op;
  wire                dst_stream_1_micro_op_uop_alu_alu_is_word;
  wire       [3:0]    dst_stream_1_micro_op_uop_bju_bju_ctrl_op;
  wire                dst_stream_1_micro_op_uop_bju_bju_rd_eq_rs1;
  wire                dst_stream_1_micro_op_uop_bju_bju_rd_is_link;
  wire                dst_stream_1_micro_op_uop_bju_bju_rs1_is_link;
  wire       [3:0]    dst_stream_1_micro_op_uop_bju_exp_ctrl_op;
  wire       [11:0]   dst_stream_1_micro_op_uop_bju_exp_csr_addr;
  wire                dst_stream_1_micro_op_uop_bju_exp_csr_wen;
  wire       [3:0]    dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op;
  wire                dst_stream_1_micro_op_uop_lsu_lsu_is_load;
  wire                dst_stream_1_micro_op_uop_lsu_lsu_is_store;
  wire       [2:0]    dst_stream_1_exe_sel;
  wire       [4:0]    dst_stream_1_rs1_addr;
  wire       [4:0]    dst_stream_1_rs2_addr;
  wire       [4:0]    dst_stream_1_rd_addr;
  wire       [63:0]   dst_stream_1_imm;
  wire       [31:0]   dst_stream_1_pc;
  wire       [31:0]   dst_stream_1_branch_pc;
  wire                dst_stream_1_branch_taken;
  wire       [31:0]   dst_stream_1_instr;
  wire                tmp_dec_src_0_ready;
  wire                tmp_1;
  reg                 tmp_2;
  wire       [31:0]   tmp_3;
  wire       [31:0]   tmp_4;
  ...
  wire       [31:0]   tmp_24;
  `ifndef SYNTHESIS
  reg [47:0] dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string;
  reg [39:0] dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string;
  reg [47:0] dec_dst_0_micro_op_uop_bju_exp_ctrl_op_string;
  reg [31:0] dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string;
  reg [31:0] dec_dst_0_exe_sel_string;
  reg [47:0] dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string;
  reg [39:0] dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string;
  reg [47:0] dec_dst_1_micro_op_uop_bju_exp_ctrl_op_string;
  reg [31:0] dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string;
  reg [31:0] dec_dst_1_exe_sel_string;
  reg [47:0] dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string;
  reg [39:0] dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string;
  reg [47:0] dst_stream_0_micro_op_uop_bju_exp_ctrl_op_string;
  reg [31:0] dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string;
  reg [31:0] dst_stream_0_exe_sel_string;
  reg [47:0] dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string;
  reg [39:0] dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string;
  reg [47:0] dst_stream_1_micro_op_uop_bju_exp_ctrl_op_string;
  reg [31:0] dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string;
  reg [31:0] dst_stream_1_exe_sel_string;
  `endif


  DecodeComb decode_comb_0 (
    .pc                               (src_stream_0_pc[31:0]                            ), //i
    .instr                            (src_stream_0_instr[31:0]                         ), //i
    .rs1_addr                         (decode_comb_0_rs1_addr[4:0]                      ), //o
    .rs2_addr                         (decode_comb_0_rs2_addr[4:0]                      ), //o
    .rd_addr                          (decode_comb_0_rd_addr[4:0]                       ), //o
    .imm                              (decode_comb_0_imm[63:0]                          ), //o
    .micro_op_uop_com_rd_wen          (decode_comb_0_micro_op_uop_com_rd_wen            ), //o
    .micro_op_uop_com_src2_is_imm     (decode_comb_0_micro_op_uop_com_src2_is_imm       ), //o
    .micro_op_uop_alu_alu_ctrl_op     (decode_comb_0_micro_op_uop_alu_alu_ctrl_op[4:0]  ), //o
    .micro_op_uop_alu_alu_is_word     (decode_comb_0_micro_op_uop_alu_alu_is_word       ), //o
    .micro_op_uop_bju_bju_ctrl_op     (decode_comb_0_micro_op_uop_bju_bju_ctrl_op[3:0]  ), //o
    .micro_op_uop_bju_bju_rd_eq_rs1   (decode_comb_0_micro_op_uop_bju_bju_rd_eq_rs1     ), //o
    .micro_op_uop_bju_bju_rd_is_link  (decode_comb_0_micro_op_uop_bju_bju_rd_is_link    ), //o
    .micro_op_uop_bju_bju_rs1_is_link (decode_comb_0_micro_op_uop_bju_bju_rs1_is_link   ), //o
    .micro_op_uop_bju_exp_ctrl_op     (decode_comb_0_micro_op_uop_bju_exp_ctrl_op[3:0]  ), //o
    .micro_op_uop_bju_exp_csr_addr    (decode_comb_0_micro_op_uop_bju_exp_csr_addr[11:0]), //o
    .micro_op_uop_bju_exp_csr_wen     (decode_comb_0_micro_op_uop_bju_exp_csr_wen       ), //o
    .micro_op_uop_lsu_lsu_ctrl_op     (decode_comb_0_micro_op_uop_lsu_lsu_ctrl_op[3:0]  ), //o
    .micro_op_uop_lsu_lsu_is_load     (decode_comb_0_micro_op_uop_lsu_lsu_is_load       ), //o
    .micro_op_uop_lsu_lsu_is_store    (decode_comb_0_micro_op_uop_lsu_lsu_is_store      ), //o
    .exe_sel                          (decode_comb_0_exe_sel[2:0]                       )  //o
  );
  DecodeComb decode_comb_1 (
    .pc                               (src_stream_1_pc[31:0]                            ), //i
    .instr                            (src_stream_1_instr[31:0]                         ), //i
    .rs1_addr                         (decode_comb_1_rs1_addr[4:0]                      ), //o
    .rs2_addr                         (decode_comb_1_rs2_addr[4:0]                      ), //o
    .rd_addr                          (decode_comb_1_rd_addr[4:0]                       ), //o
    .imm                              (decode_comb_1_imm[63:0]                          ), //o
    .micro_op_uop_com_rd_wen          (decode_comb_1_micro_op_uop_com_rd_wen            ), //o
    .micro_op_uop_com_src2_is_imm     (decode_comb_1_micro_op_uop_com_src2_is_imm       ), //o
    .micro_op_uop_alu_alu_ctrl_op     (decode_comb_1_micro_op_uop_alu_alu_ctrl_op[4:0]  ), //o
    .micro_op_uop_alu_alu_is_word     (decode_comb_1_micro_op_uop_alu_alu_is_word       ), //o
    .micro_op_uop_bju_bju_ctrl_op     (decode_comb_1_micro_op_uop_bju_bju_ctrl_op[3:0]  ), //o
    .micro_op_uop_bju_bju_rd_eq_rs1   (decode_comb_1_micro_op_uop_bju_bju_rd_eq_rs1     ), //o
    .micro_op_uop_bju_bju_rd_is_link  (decode_comb_1_micro_op_uop_bju_bju_rd_is_link    ), //o
    .micro_op_uop_bju_bju_rs1_is_link (decode_comb_1_micro_op_uop_bju_bju_rs1_is_link   ), //o
    .micro_op_uop_bju_exp_ctrl_op     (decode_comb_1_micro_op_uop_bju_exp_ctrl_op[3:0]  ), //o
    .micro_op_uop_bju_exp_csr_addr    (decode_comb_1_micro_op_uop_bju_exp_csr_addr[11:0]), //o
    .micro_op_uop_bju_exp_csr_wen     (decode_comb_1_micro_op_uop_bju_exp_csr_wen       ), //o
    .micro_op_uop_lsu_lsu_ctrl_op     (decode_comb_1_micro_op_uop_lsu_lsu_ctrl_op[3:0]  ), //o
    .micro_op_uop_lsu_lsu_is_load     (decode_comb_1_micro_op_uop_lsu_lsu_is_load       ), //o
    .micro_op_uop_lsu_lsu_is_store    (decode_comb_1_micro_op_uop_lsu_lsu_is_store      ), //o
    .exe_sel                          (decode_comb_1_exe_sel[2:0]                       )  //o
  );
  `ifndef SYNTHESIS
  always @(*) begin
    case(dec_dst_0_micro_op_uop_alu_alu_ctrl_op)
      AluCtrlEnum_IDLE : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "IDLE  ";
      AluCtrlEnum_ADD : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "ADD   ";
      AluCtrlEnum_SUB : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "SUB   ";
      AluCtrlEnum_SLT : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "SLT   ";
      AluCtrlEnum_SLTU : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "SLTU  ";
      AluCtrlEnum_XOR_1 : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "XOR_1 ";
      AluCtrlEnum_SLL_1 : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "SLL_1 ";
      AluCtrlEnum_SRL_1 : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "SRL_1 ";
      AluCtrlEnum_SRA_1 : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "SRA_1 ";
      AluCtrlEnum_AND_1 : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "AND_1 ";
      AluCtrlEnum_OR_1 : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "OR_1  ";
      AluCtrlEnum_LUI : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "LUI   ";
      AluCtrlEnum_MUL : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "MUL   ";
      AluCtrlEnum_MULH : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "MULH  ";
      AluCtrlEnum_MULHSU : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "MULHSU";
      AluCtrlEnum_MULHU : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "MULHU ";
      AluCtrlEnum_DIV : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "DIV   ";
      AluCtrlEnum_DIVU : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "DIVU  ";
      AluCtrlEnum_REM_1 : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "REM_1 ";
      AluCtrlEnum_REMU : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "REMU  ";
      AluCtrlEnum_MULW : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "MULW  ";
      AluCtrlEnum_DIVW : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "DIVW  ";
      AluCtrlEnum_DIVUW : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "DIVUW ";
      AluCtrlEnum_REMW : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "REMW  ";
      AluCtrlEnum_REMUW : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "REMUW ";
      default : dec_dst_0_micro_op_uop_alu_alu_ctrl_op_string = "??????";
    endcase
  end
  always @(*) begin
    case(dec_dst_0_micro_op_uop_bju_bju_ctrl_op)
      BjuCtrlEnum_IDLE : dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string = "IDLE ";
      BjuCtrlEnum_AUIPC : dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string = "AUIPC";
      BjuCtrlEnum_JAL : dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string = "JAL  ";
      BjuCtrlEnum_JALR : dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string = "JALR ";
      BjuCtrlEnum_BEQ : dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string = "BEQ  ";
      BjuCtrlEnum_BNE : dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string = "BNE  ";
      BjuCtrlEnum_BLT : dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string = "BLT  ";
      BjuCtrlEnum_BGE : dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string = "BGE  ";
      BjuCtrlEnum_BLTU : dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string = "BLTU ";
      BjuCtrlEnum_BGEU : dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string = "BGEU ";
      BjuCtrlEnum_CSR : dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string = "CSR  ";
      default : dec_dst_0_micro_op_uop_bju_bju_ctrl_op_string = "?????";
    endcase
  end
  always @(*) begin
    case(dec_dst_0_micro_op_uop_bju_exp_ctrl_op)
      ExpCtrlEnum_IDLE : dec_dst_0_micro_op_uop_bju_exp_ctrl_op_string = "IDLE  ";
      ExpCtrlEnum_ECALL : dec_dst_0_micro_op_uop_bju_exp_ctrl_op_string = "ECALL ";
      ExpCtrlEnum_EBREAK : dec_dst_0_micro_op_uop_bju_exp_ctrl_op_string = "EBREAK";
      ExpCtrlEnum_MRET : dec_dst_0_micro_op_uop_bju_exp_ctrl_op_string = "MRET  ";
      ExpCtrlEnum_CSRRW : dec_dst_0_micro_op_uop_bju_exp_ctrl_op_string = "CSRRW ";
      ExpCtrlEnum_CSRRS : dec_dst_0_micro_op_uop_bju_exp_ctrl_op_string = "CSRRS ";
      ExpCtrlEnum_CSRRC : dec_dst_0_micro_op_uop_bju_exp_ctrl_op_string = "CSRRC ";
      ExpCtrlEnum_CSRRWI : dec_dst_0_micro_op_uop_bju_exp_ctrl_op_string = "CSRRWI";
      ExpCtrlEnum_CSRRSI : dec_dst_0_micro_op_uop_bju_exp_ctrl_op_string = "CSRRSI";
      ExpCtrlEnum_CSRRCI : dec_dst_0_micro_op_uop_bju_exp_ctrl_op_string = "CSRRCI";
      default : dec_dst_0_micro_op_uop_bju_exp_ctrl_op_string = "??????";
    endcase
  end
  always @(*) begin
    case(dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op)
      LsuCtrlEnum_IDLE : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "IDLE";
      LsuCtrlEnum_LB : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LB  ";
      LsuCtrlEnum_LBU : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LBU ";
      LsuCtrlEnum_LH : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LH  ";
      LsuCtrlEnum_LHU : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LHU ";
      LsuCtrlEnum_LW : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LW  ";
      LsuCtrlEnum_LWU : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LWU ";
      LsuCtrlEnum_LD : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LD  ";
      LsuCtrlEnum_SB : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "SB  ";
      LsuCtrlEnum_SH : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "SH  ";
      LsuCtrlEnum_SW : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "SW  ";
      LsuCtrlEnum_SD : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "SD  ";
      default : dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op_string = "????";
    endcase
  end
  always @(*) begin
    case(dec_dst_0_exe_sel)
      ExeSelEnum_IDLE : dec_dst_0_exe_sel_string = "IDLE";
      ExeSelEnum_ALU : dec_dst_0_exe_sel_string = "ALU ";
      ExeSelEnum_BJU : dec_dst_0_exe_sel_string = "BJU ";
      ExeSelEnum_LSU : dec_dst_0_exe_sel_string = "LSU ";
      ExeSelEnum_DIV : dec_dst_0_exe_sel_string = "DIV ";
      default : dec_dst_0_exe_sel_string = "????";
    endcase
  end
  always @(*) begin
    case(dec_dst_1_micro_op_uop_alu_alu_ctrl_op)
      AluCtrlEnum_IDLE : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "IDLE  ";
      AluCtrlEnum_ADD : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "ADD   ";
      AluCtrlEnum_SUB : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "SUB   ";
      AluCtrlEnum_SLT : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "SLT   ";
      AluCtrlEnum_SLTU : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "SLTU  ";
      AluCtrlEnum_XOR_1 : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "XOR_1 ";
      AluCtrlEnum_SLL_1 : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "SLL_1 ";
      AluCtrlEnum_SRL_1 : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "SRL_1 ";
      AluCtrlEnum_SRA_1 : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "SRA_1 ";
      AluCtrlEnum_AND_1 : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "AND_1 ";
      AluCtrlEnum_OR_1 : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "OR_1  ";
      AluCtrlEnum_LUI : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "LUI   ";
      AluCtrlEnum_MUL : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "MUL   ";
      AluCtrlEnum_MULH : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "MULH  ";
      AluCtrlEnum_MULHSU : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "MULHSU";
      AluCtrlEnum_MULHU : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "MULHU ";
      AluCtrlEnum_DIV : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "DIV   ";
      AluCtrlEnum_DIVU : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "DIVU  ";
      AluCtrlEnum_REM_1 : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "REM_1 ";
      AluCtrlEnum_REMU : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "REMU  ";
      AluCtrlEnum_MULW : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "MULW  ";
      AluCtrlEnum_DIVW : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "DIVW  ";
      AluCtrlEnum_DIVUW : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "DIVUW ";
      AluCtrlEnum_REMW : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "REMW  ";
      AluCtrlEnum_REMUW : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "REMUW ";
      default : dec_dst_1_micro_op_uop_alu_alu_ctrl_op_string = "??????";
    endcase
  end
  always @(*) begin
    case(dec_dst_1_micro_op_uop_bju_bju_ctrl_op)
      BjuCtrlEnum_IDLE : dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string = "IDLE ";
      BjuCtrlEnum_AUIPC : dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string = "AUIPC";
      BjuCtrlEnum_JAL : dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string = "JAL  ";
      BjuCtrlEnum_JALR : dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string = "JALR ";
      BjuCtrlEnum_BEQ : dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string = "BEQ  ";
      BjuCtrlEnum_BNE : dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string = "BNE  ";
      BjuCtrlEnum_BLT : dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string = "BLT  ";
      BjuCtrlEnum_BGE : dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string = "BGE  ";
      BjuCtrlEnum_BLTU : dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string = "BLTU ";
      BjuCtrlEnum_BGEU : dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string = "BGEU ";
      BjuCtrlEnum_CSR : dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string = "CSR  ";
      default : dec_dst_1_micro_op_uop_bju_bju_ctrl_op_string = "?????";
    endcase
  end
  always @(*) begin
    case(dec_dst_1_micro_op_uop_bju_exp_ctrl_op)
      ExpCtrlEnum_IDLE : dec_dst_1_micro_op_uop_bju_exp_ctrl_op_string = "IDLE  ";
      ExpCtrlEnum_ECALL : dec_dst_1_micro_op_uop_bju_exp_ctrl_op_string = "ECALL ";
      ExpCtrlEnum_EBREAK : dec_dst_1_micro_op_uop_bju_exp_ctrl_op_string = "EBREAK";
      ExpCtrlEnum_MRET : dec_dst_1_micro_op_uop_bju_exp_ctrl_op_string = "MRET  ";
      ExpCtrlEnum_CSRRW : dec_dst_1_micro_op_uop_bju_exp_ctrl_op_string = "CSRRW ";
      ExpCtrlEnum_CSRRS : dec_dst_1_micro_op_uop_bju_exp_ctrl_op_string = "CSRRS ";
      ExpCtrlEnum_CSRRC : dec_dst_1_micro_op_uop_bju_exp_ctrl_op_string = "CSRRC ";
      ExpCtrlEnum_CSRRWI : dec_dst_1_micro_op_uop_bju_exp_ctrl_op_string = "CSRRWI";
      ExpCtrlEnum_CSRRSI : dec_dst_1_micro_op_uop_bju_exp_ctrl_op_string = "CSRRSI";
      ExpCtrlEnum_CSRRCI : dec_dst_1_micro_op_uop_bju_exp_ctrl_op_string = "CSRRCI";
      default : dec_dst_1_micro_op_uop_bju_exp_ctrl_op_string = "??????";
    endcase
  end
  always @(*) begin
    case(dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op)
      LsuCtrlEnum_IDLE : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "IDLE";
      LsuCtrlEnum_LB : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LB  ";
      LsuCtrlEnum_LBU : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LBU ";
      LsuCtrlEnum_LH : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LH  ";
      LsuCtrlEnum_LHU : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LHU ";
      LsuCtrlEnum_LW : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LW  ";
      LsuCtrlEnum_LWU : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LWU ";
      LsuCtrlEnum_LD : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LD  ";
      LsuCtrlEnum_SB : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "SB  ";
      LsuCtrlEnum_SH : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "SH  ";
      LsuCtrlEnum_SW : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "SW  ";
      LsuCtrlEnum_SD : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "SD  ";
      default : dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op_string = "????";
    endcase
  end
  always @(*) begin
    case(dec_dst_1_exe_sel)
      ExeSelEnum_IDLE : dec_dst_1_exe_sel_string = "IDLE";
      ExeSelEnum_ALU : dec_dst_1_exe_sel_string = "ALU ";
      ExeSelEnum_BJU : dec_dst_1_exe_sel_string = "BJU ";
      ExeSelEnum_LSU : dec_dst_1_exe_sel_string = "LSU ";
      ExeSelEnum_DIV : dec_dst_1_exe_sel_string = "DIV ";
      default : dec_dst_1_exe_sel_string = "????";
    endcase
  end
  always @(*) begin
    case(dst_stream_0_micro_op_uop_alu_alu_ctrl_op)
      AluCtrlEnum_IDLE : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "IDLE  ";
      AluCtrlEnum_ADD : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "ADD   ";
      AluCtrlEnum_SUB : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "SUB   ";
      AluCtrlEnum_SLT : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "SLT   ";
      AluCtrlEnum_SLTU : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "SLTU  ";
      AluCtrlEnum_XOR_1 : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "XOR_1 ";
      AluCtrlEnum_SLL_1 : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "SLL_1 ";
      AluCtrlEnum_SRL_1 : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "SRL_1 ";
      AluCtrlEnum_SRA_1 : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "SRA_1 ";
      AluCtrlEnum_AND_1 : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "AND_1 ";
      AluCtrlEnum_OR_1 : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "OR_1  ";
      AluCtrlEnum_LUI : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "LUI   ";
      AluCtrlEnum_MUL : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "MUL   ";
      AluCtrlEnum_MULH : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "MULH  ";
      AluCtrlEnum_MULHSU : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "MULHSU";
      AluCtrlEnum_MULHU : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "MULHU ";
      AluCtrlEnum_DIV : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "DIV   ";
      AluCtrlEnum_DIVU : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "DIVU  ";
      AluCtrlEnum_REM_1 : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "REM_1 ";
      AluCtrlEnum_REMU : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "REMU  ";
      AluCtrlEnum_MULW : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "MULW  ";
      AluCtrlEnum_DIVW : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "DIVW  ";
      AluCtrlEnum_DIVUW : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "DIVUW ";
      AluCtrlEnum_REMW : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "REMW  ";
      AluCtrlEnum_REMUW : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "REMUW ";
      default : dst_stream_0_micro_op_uop_alu_alu_ctrl_op_string = "??????";
    endcase
  end
  always @(*) begin
    case(dst_stream_0_micro_op_uop_bju_bju_ctrl_op)
      BjuCtrlEnum_IDLE : dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string = "IDLE ";
      BjuCtrlEnum_AUIPC : dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string = "AUIPC";
      BjuCtrlEnum_JAL : dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string = "JAL  ";
      BjuCtrlEnum_JALR : dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string = "JALR ";
      BjuCtrlEnum_BEQ : dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string = "BEQ  ";
      BjuCtrlEnum_BNE : dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string = "BNE  ";
      BjuCtrlEnum_BLT : dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string = "BLT  ";
      BjuCtrlEnum_BGE : dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string = "BGE  ";
      BjuCtrlEnum_BLTU : dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string = "BLTU ";
      BjuCtrlEnum_BGEU : dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string = "BGEU ";
      BjuCtrlEnum_CSR : dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string = "CSR  ";
      default : dst_stream_0_micro_op_uop_bju_bju_ctrl_op_string = "?????";
    endcase
  end
  always @(*) begin
    case(dst_stream_0_micro_op_uop_bju_exp_ctrl_op)
      ExpCtrlEnum_IDLE : dst_stream_0_micro_op_uop_bju_exp_ctrl_op_string = "IDLE  ";
      ExpCtrlEnum_ECALL : dst_stream_0_micro_op_uop_bju_exp_ctrl_op_string = "ECALL ";
      ExpCtrlEnum_EBREAK : dst_stream_0_micro_op_uop_bju_exp_ctrl_op_string = "EBREAK";
      ExpCtrlEnum_MRET : dst_stream_0_micro_op_uop_bju_exp_ctrl_op_string = "MRET  ";
      ExpCtrlEnum_CSRRW : dst_stream_0_micro_op_uop_bju_exp_ctrl_op_string = "CSRRW ";
      ExpCtrlEnum_CSRRS : dst_stream_0_micro_op_uop_bju_exp_ctrl_op_string = "CSRRS ";
      ExpCtrlEnum_CSRRC : dst_stream_0_micro_op_uop_bju_exp_ctrl_op_string = "CSRRC ";
      ExpCtrlEnum_CSRRWI : dst_stream_0_micro_op_uop_bju_exp_ctrl_op_string = "CSRRWI";
      ExpCtrlEnum_CSRRSI : dst_stream_0_micro_op_uop_bju_exp_ctrl_op_string = "CSRRSI";
      ExpCtrlEnum_CSRRCI : dst_stream_0_micro_op_uop_bju_exp_ctrl_op_string = "CSRRCI";
      default : dst_stream_0_micro_op_uop_bju_exp_ctrl_op_string = "??????";
    endcase
  end
  always @(*) begin
    case(dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op)
      LsuCtrlEnum_IDLE : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "IDLE";
      LsuCtrlEnum_LB : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LB  ";
      LsuCtrlEnum_LBU : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LBU ";
      LsuCtrlEnum_LH : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LH  ";
      LsuCtrlEnum_LHU : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LHU ";
      LsuCtrlEnum_LW : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LW  ";
      LsuCtrlEnum_LWU : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LWU ";
      LsuCtrlEnum_LD : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "LD  ";
      LsuCtrlEnum_SB : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "SB  ";
      LsuCtrlEnum_SH : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "SH  ";
      LsuCtrlEnum_SW : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "SW  ";
      LsuCtrlEnum_SD : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "SD  ";
      default : dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op_string = "????";
    endcase
  end
  always @(*) begin
    case(dst_stream_0_exe_sel)
      ExeSelEnum_IDLE : dst_stream_0_exe_sel_string = "IDLE";
      ExeSelEnum_ALU : dst_stream_0_exe_sel_string = "ALU ";
      ExeSelEnum_BJU : dst_stream_0_exe_sel_string = "BJU ";
      ExeSelEnum_LSU : dst_stream_0_exe_sel_string = "LSU ";
      ExeSelEnum_DIV : dst_stream_0_exe_sel_string = "DIV ";
      default : dst_stream_0_exe_sel_string = "????";
    endcase
  end
  always @(*) begin
    case(dst_stream_1_micro_op_uop_alu_alu_ctrl_op)
      AluCtrlEnum_IDLE : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "IDLE  ";
      AluCtrlEnum_ADD : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "ADD   ";
      AluCtrlEnum_SUB : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "SUB   ";
      AluCtrlEnum_SLT : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "SLT   ";
      AluCtrlEnum_SLTU : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "SLTU  ";
      AluCtrlEnum_XOR_1 : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "XOR_1 ";
      AluCtrlEnum_SLL_1 : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "SLL_1 ";
      AluCtrlEnum_SRL_1 : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "SRL_1 ";
      AluCtrlEnum_SRA_1 : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "SRA_1 ";
      AluCtrlEnum_AND_1 : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "AND_1 ";
      AluCtrlEnum_OR_1 : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "OR_1  ";
      AluCtrlEnum_LUI : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "LUI   ";
      AluCtrlEnum_MUL : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "MUL   ";
      AluCtrlEnum_MULH : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "MULH  ";
      AluCtrlEnum_MULHSU : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "MULHSU";
      AluCtrlEnum_MULHU : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "MULHU ";
      AluCtrlEnum_DIV : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "DIV   ";
      AluCtrlEnum_DIVU : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "DIVU  ";
      AluCtrlEnum_REM_1 : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "REM_1 ";
      AluCtrlEnum_REMU : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "REMU  ";
      AluCtrlEnum_MULW : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "MULW  ";
      AluCtrlEnum_DIVW : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "DIVW  ";
      AluCtrlEnum_DIVUW : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "DIVUW ";
      AluCtrlEnum_REMW : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "REMW  ";
      AluCtrlEnum_REMUW : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "REMUW ";
      default : dst_stream_1_micro_op_uop_alu_alu_ctrl_op_string = "??????";
    endcase
  end
  always @(*) begin
    case(dst_stream_1_micro_op_uop_bju_bju_ctrl_op)
      BjuCtrlEnum_IDLE : dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string = "IDLE ";
      BjuCtrlEnum_AUIPC : dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string = "AUIPC";
      BjuCtrlEnum_JAL : dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string = "JAL  ";
      BjuCtrlEnum_JALR : dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string = "JALR ";
      BjuCtrlEnum_BEQ : dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string = "BEQ  ";
      BjuCtrlEnum_BNE : dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string = "BNE  ";
      BjuCtrlEnum_BLT : dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string = "BLT  ";
      BjuCtrlEnum_BGE : dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string = "BGE  ";
      BjuCtrlEnum_BLTU : dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string = "BLTU ";
      BjuCtrlEnum_BGEU : dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string = "BGEU ";
      BjuCtrlEnum_CSR : dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string = "CSR  ";
      default : dst_stream_1_micro_op_uop_bju_bju_ctrl_op_string = "?????";
    endcase
  end
  always @(*) begin
    case(dst_stream_1_micro_op_uop_bju_exp_ctrl_op)
      ExpCtrlEnum_IDLE : dst_stream_1_micro_op_uop_bju_exp_ctrl_op_string = "IDLE  ";
      ExpCtrlEnum_ECALL : dst_stream_1_micro_op_uop_bju_exp_ctrl_op_string = "ECALL ";
      ExpCtrlEnum_EBREAK : dst_stream_1_micro_op_uop_bju_exp_ctrl_op_string = "EBREAK";
      ExpCtrlEnum_MRET : dst_stream_1_micro_op_uop_bju_exp_ctrl_op_string = "MRET  ";
      ExpCtrlEnum_CSRRW : dst_stream_1_micro_op_uop_bju_exp_ctrl_op_string = "CSRRW ";
      ExpCtrlEnum_CSRRS : dst_stream_1_micro_op_uop_bju_exp_ctrl_op_string = "CSRRS ";
      ExpCtrlEnum_CSRRC : dst_stream_1_micro_op_uop_bju_exp_ctrl_op_string = "CSRRC ";
      ExpCtrlEnum_CSRRWI : dst_stream_1_micro_op_uop_bju_exp_ctrl_op_string = "CSRRWI";
      ExpCtrlEnum_CSRRSI : dst_stream_1_micro_op_uop_bju_exp_ctrl_op_string = "CSRRSI";
      ExpCtrlEnum_CSRRCI : dst_stream_1_micro_op_uop_bju_exp_ctrl_op_string = "CSRRCI";
      default : dst_stream_1_micro_op_uop_bju_exp_ctrl_op_string = "??????";
    endcase
  end
  always @(*) begin
    case(dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op)
      LsuCtrlEnum_IDLE : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "IDLE";
      LsuCtrlEnum_LB : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LB  ";
      LsuCtrlEnum_LBU : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LBU ";
      LsuCtrlEnum_LH : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LH  ";
      LsuCtrlEnum_LHU : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LHU ";
      LsuCtrlEnum_LW : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LW  ";
      LsuCtrlEnum_LWU : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LWU ";
      LsuCtrlEnum_LD : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "LD  ";
      LsuCtrlEnum_SB : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "SB  ";
      LsuCtrlEnum_SH : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "SH  ";
      LsuCtrlEnum_SW : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "SW  ";
      LsuCtrlEnum_SD : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "SD  ";
      default : dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op_string = "????";
    endcase
  end
  always @(*) begin
    case(dst_stream_1_exe_sel)
      ExeSelEnum_IDLE : dst_stream_1_exe_sel_string = "IDLE";
      ExeSelEnum_ALU : dst_stream_1_exe_sel_string = "ALU ";
      ExeSelEnum_BJU : dst_stream_1_exe_sel_string = "BJU ";
      ExeSelEnum_LSU : dst_stream_1_exe_sel_string = "LSU ";
      ExeSelEnum_DIV : dst_stream_1_exe_sel_string = "DIV ";
      default : dst_stream_1_exe_sel_string = "????";
    endcase
  end
  `endif

  assign tmp_dec_src_0_ready = (! stall); // @ BaseType.scala l299
  assign tmp_1 = (dec_src_0_valid && tmp_dec_src_0_ready); // @ Stream.scala l426
  assign dec_src_0_ready = (tmp_2 && tmp_dec_src_0_ready); // @ Stream.scala l427
  assign tmp_3 = dec_src_0_pc; // @ Stream.scala l428
  assign tmp_4 = dec_src_0_branch_pc; // @ Stream.scala l428
  assign tmp_5 = dec_src_0_branch_taken; // @ Stream.scala l428
  assign tmp_6 = dec_src_0_instr; // @ Stream.scala l428
  always @(*) begin
    tmp_7 = tmp_1; // @ Stream.scala l294
    if(flush) begin
      tmp_7 = 1'b0; // @ Stream.scala l439
    end
  end

  always @(*) begin
    tmp_2 = tmp_8; // @ Stream.scala l295
    if(flush) begin
      tmp_2 = 1'b1; // @ Stream.scala l440
    end
  end

  assign tmp_9 = tmp_3; // @ Stream.scala l296
  assign tmp_10 = tmp_4; // @ Stream.scala l296
  assign tmp_11 = tmp_5; // @ Stream.scala l296
  assign tmp_12 = tmp_6; // @ Stream.scala l296
  assign src_stream_0_valid = tmp_7; // @ Stream.scala l294
  assign tmp_8 = src_stream_0_ready; // @ Stream.scala l295
  assign src_stream_0_pc = tmp_9; // @ Stream.scala l296
  assign src_stream_0_branch_pc = tmp_10; // @ Stream.scala l296
  assign src_stream_0_branch_taken = tmp_11; // @ Stream.scala l296
  assign src_stream_0_instr = tmp_12; // @ Stream.scala l296
  assign src_stream_0_ready = dst_stream_0_ready; // @ Decode.scala l296
  assign dst_stream_0_valid = src_stream_0_valid; // @ Decode.scala l303
  assign dst_stream_0_pc = src_stream_0_pc; // @ Decode.scala l304
  assign dst_stream_0_branch_pc = src_stream_0_branch_pc; // @ Decode.scala l305
  assign dst_stream_0_branch_taken = src_stream_0_branch_taken; // @ Decode.scala l306
  assign dst_stream_0_instr = src_stream_0_instr; // @ Decode.scala l307
  assign dst_stream_0_micro_op_uop_com_rd_wen = decode_comb_0_micro_op_uop_com_rd_wen; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_com_src2_is_imm = decode_comb_0_micro_op_uop_com_src2_is_imm; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_alu_alu_ctrl_op = decode_comb_0_micro_op_uop_alu_alu_ctrl_op; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_alu_alu_is_word = decode_comb_0_micro_op_uop_alu_alu_is_word; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_bju_bju_ctrl_op = decode_comb_0_micro_op_uop_bju_bju_ctrl_op; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_bju_bju_rd_eq_rs1 = decode_comb_0_micro_op_uop_bju_bju_rd_eq_rs1; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_bju_bju_rd_is_link = decode_comb_0_micro_op_uop_bju_bju_rd_is_link; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_bju_bju_rs1_is_link = decode_comb_0_micro_op_uop_bju_bju_rs1_is_link; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_bju_exp_ctrl_op = decode_comb_0_micro_op_uop_bju_exp_ctrl_op; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_bju_exp_csr_addr = decode_comb_0_micro_op_uop_bju_exp_csr_addr; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_bju_exp_csr_wen = decode_comb_0_micro_op_uop_bju_exp_csr_wen; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op = decode_comb_0_micro_op_uop_lsu_lsu_ctrl_op; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_lsu_lsu_is_load = decode_comb_0_micro_op_uop_lsu_lsu_is_load; // @ Decode.scala l308
  assign dst_stream_0_micro_op_uop_lsu_lsu_is_store = decode_comb_0_micro_op_uop_lsu_lsu_is_store; // @ Decode.scala l308
  assign dst_stream_0_exe_sel = decode_comb_0_exe_sel; // @ Decode.scala l309
  assign dst_stream_0_rs1_addr = decode_comb_0_rs1_addr; // @ Decode.scala l310
  assign dst_stream_0_rs2_addr = decode_comb_0_rs2_addr; // @ Decode.scala l311
  assign dst_stream_0_rd_addr = decode_comb_0_rd_addr; // @ Decode.scala l312
  assign dst_stream_0_imm = decode_comb_0_imm; // @ Decode.scala l313
  assign dec_dst_0_valid = dst_stream_0_valid; // @ Stream.scala l294
  assign dst_stream_0_ready = dec_dst_0_ready; // @ Stream.scala l295
  assign dec_dst_0_micro_op_uop_com_rd_wen = dst_stream_0_micro_op_uop_com_rd_wen; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_com_src2_is_imm = dst_stream_0_micro_op_uop_com_src2_is_imm; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_alu_alu_ctrl_op = dst_stream_0_micro_op_uop_alu_alu_ctrl_op; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_alu_alu_is_word = dst_stream_0_micro_op_uop_alu_alu_is_word; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_bju_bju_ctrl_op = dst_stream_0_micro_op_uop_bju_bju_ctrl_op; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_bju_bju_rd_eq_rs1 = dst_stream_0_micro_op_uop_bju_bju_rd_eq_rs1; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_bju_bju_rd_is_link = dst_stream_0_micro_op_uop_bju_bju_rd_is_link; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_bju_bju_rs1_is_link = dst_stream_0_micro_op_uop_bju_bju_rs1_is_link; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_bju_exp_ctrl_op = dst_stream_0_micro_op_uop_bju_exp_ctrl_op; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_bju_exp_csr_addr = dst_stream_0_micro_op_uop_bju_exp_csr_addr; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_bju_exp_csr_wen = dst_stream_0_micro_op_uop_bju_exp_csr_wen; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_lsu_lsu_ctrl_op = dst_stream_0_micro_op_uop_lsu_lsu_ctrl_op; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_lsu_lsu_is_load = dst_stream_0_micro_op_uop_lsu_lsu_is_load; // @ Stream.scala l296
  assign dec_dst_0_micro_op_uop_lsu_lsu_is_store = dst_stream_0_micro_op_uop_lsu_lsu_is_store; // @ Stream.scala l296
  assign dec_dst_0_exe_sel = dst_stream_0_exe_sel; // @ Stream.scala l296
  assign dec_dst_0_rs1_addr = dst_stream_0_rs1_addr; // @ Stream.scala l296
  assign dec_dst_0_rs2_addr = dst_stream_0_rs2_addr; // @ Stream.scala l296
  assign dec_dst_0_rd_addr = dst_stream_0_rd_addr; // @ Stream.scala l296
  assign dec_dst_0_imm = dst_stream_0_imm; // @ Stream.scala l296
  assign dec_dst_0_pc = dst_stream_0_pc; // @ Stream.scala l296
  assign dec_dst_0_branch_pc = dst_stream_0_branch_pc; // @ Stream.scala l296
  assign dec_dst_0_branch_taken = dst_stream_0_branch_taken; // @ Stream.scala l296
  assign dec_dst_0_instr = dst_stream_0_instr; // @ Stream.scala l296
  assign tmp_dec_src_1_ready = (! stall); // @ BaseType.scala l299
  assign tmp_13 = (dec_src_1_valid && tmp_dec_src_1_ready); // @ Stream.scala l426
  assign dec_src_1_ready = (tmp_14 && tmp_dec_src_1_ready); // @ Stream.scala l427
  assign tmp_15 = dec_src_1_pc; // @ Stream.scala l428
  assign tmp_16 = dec_src_1_branch_pc; // @ Stream.scala l428
  assign tmp_17 = dec_src_1_branch_taken; // @ Stream.scala l428
  assign tmp_18 = dec_src_1_instr; // @ Stream.scala l428
  always @(*) begin
    tmp_19 = tmp_13; // @ Stream.scala l294
    if(flush) begin
      tmp_19 = 1'b0; // @ Stream.scala l439
    end
  end

  always @(*) begin
    tmp_14 = tmp_20; // @ Stream.scala l295
    if(flush) begin
      tmp_14 = 1'b1; // @ Stream.scala l440
    end
  end

  assign tmp_21 = tmp_15; // @ Stream.scala l296
  assign tmp_22 = tmp_16; // @ Stream.scala l296
  assign tmp_23 = tmp_17; // @ Stream.scala l296
  assign tmp_24 = tmp_18; // @ Stream.scala l296
  assign src_stream_1_valid = tmp_19; // @ Stream.scala l294
  assign tmp_20 = src_stream_1_ready; // @ Stream.scala l295
  assign src_stream_1_pc = tmp_21; // @ Stream.scala l296
  assign src_stream_1_branch_pc = tmp_22; // @ Stream.scala l296
  assign src_stream_1_branch_taken = tmp_23; // @ Stream.scala l296
  assign src_stream_1_instr = tmp_24; // @ Stream.scala l296
  assign src_stream_1_ready = dst_stream_1_ready; // @ Decode.scala l296
  assign dst_stream_1_valid = src_stream_1_valid; // @ Decode.scala l303
  assign dst_stream_1_pc = src_stream_1_pc; // @ Decode.scala l304
  assign dst_stream_1_branch_pc = src_stream_1_branch_pc; // @ Decode.scala l305
  assign dst_stream_1_branch_taken = src_stream_1_branch_taken; // @ Decode.scala l306
  assign dst_stream_1_instr = src_stream_1_instr; // @ Decode.scala l307
  assign dst_stream_1_micro_op_uop_com_rd_wen = decode_comb_1_micro_op_uop_com_rd_wen; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_com_src2_is_imm = decode_comb_1_micro_op_uop_com_src2_is_imm; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_alu_alu_ctrl_op = decode_comb_1_micro_op_uop_alu_alu_ctrl_op; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_alu_alu_is_word = decode_comb_1_micro_op_uop_alu_alu_is_word; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_bju_bju_ctrl_op = decode_comb_1_micro_op_uop_bju_bju_ctrl_op; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_bju_bju_rd_eq_rs1 = decode_comb_1_micro_op_uop_bju_bju_rd_eq_rs1; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_bju_bju_rd_is_link = decode_comb_1_micro_op_uop_bju_bju_rd_is_link; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_bju_bju_rs1_is_link = decode_comb_1_micro_op_uop_bju_bju_rs1_is_link; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_bju_exp_ctrl_op = decode_comb_1_micro_op_uop_bju_exp_ctrl_op; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_bju_exp_csr_addr = decode_comb_1_micro_op_uop_bju_exp_csr_addr; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_bju_exp_csr_wen = decode_comb_1_micro_op_uop_bju_exp_csr_wen; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op = decode_comb_1_micro_op_uop_lsu_lsu_ctrl_op; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_lsu_lsu_is_load = decode_comb_1_micro_op_uop_lsu_lsu_is_load; // @ Decode.scala l308
  assign dst_stream_1_micro_op_uop_lsu_lsu_is_store = decode_comb_1_micro_op_uop_lsu_lsu_is_store; // @ Decode.scala l308
  assign dst_stream_1_exe_sel = decode_comb_1_exe_sel; // @ Decode.scala l309
  assign dst_stream_1_rs1_addr = decode_comb_1_rs1_addr; // @ Decode.scala l310
  assign dst_stream_1_rs2_addr = decode_comb_1_rs2_addr; // @ Decode.scala l311
  assign dst_stream_1_rd_addr = decode_comb_1_rd_addr; // @ Decode.scala l312
  assign dst_stream_1_imm = decode_comb_1_imm; // @ Decode.scala l313
  assign dec_dst_1_valid = dst_stream_1_valid; // @ Stream.scala l294
  assign dst_stream_1_ready = dec_dst_1_ready; // @ Stream.scala l295
  assign dec_dst_1_micro_op_uop_com_rd_wen = dst_stream_1_micro_op_uop_com_rd_wen; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_com_src2_is_imm = dst_stream_1_micro_op_uop_com_src2_is_imm; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_alu_alu_ctrl_op = dst_stream_1_micro_op_uop_alu_alu_ctrl_op; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_alu_alu_is_word = dst_stream_1_micro_op_uop_alu_alu_is_word; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_bju_bju_ctrl_op = dst_stream_1_micro_op_uop_bju_bju_ctrl_op; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_bju_bju_rd_eq_rs1 = dst_stream_1_micro_op_uop_bju_bju_rd_eq_rs1; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_bju_bju_rd_is_link = dst_stream_1_micro_op_uop_bju_bju_rd_is_link; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_bju_bju_rs1_is_link = dst_stream_1_micro_op_uop_bju_bju_rs1_is_link; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_bju_exp_ctrl_op = dst_stream_1_micro_op_uop_bju_exp_ctrl_op; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_bju_exp_csr_addr = dst_stream_1_micro_op_uop_bju_exp_csr_addr; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_bju_exp_csr_wen = dst_stream_1_micro_op_uop_bju_exp_csr_wen; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_lsu_lsu_ctrl_op = dst_stream_1_micro_op_uop_lsu_lsu_ctrl_op; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_lsu_lsu_is_load = dst_stream_1_micro_op_uop_lsu_lsu_is_load; // @ Stream.scala l296
  assign dec_dst_1_micro_op_uop_lsu_lsu_is_store = dst_stream_1_micro_op_uop_lsu_lsu_is_store; // @ Stream.scala l296
  assign dec_dst_1_exe_sel = dst_stream_1_exe_sel; // @ Stream.scala l296
  assign dec_dst_1_rs1_addr = dst_stream_1_rs1_addr; // @ Stream.scala l296
  assign dec_dst_1_rs2_addr = dst_stream_1_rs2_addr; // @ Stream.scala l296
  assign dec_dst_1_rd_addr = dst_stream_1_rd_addr; // @ Stream.scala l296
  assign dec_dst_1_imm = dst_stream_1_imm; // @ Stream.scala l296
  assign dec_dst_1_pc = dst_stream_1_pc; // @ Stream.scala l296
  assign dec_dst_1_branch_pc = dst_stream_1_branch_pc; // @ Stream.scala l296
  assign dec_dst_1_branch_taken = dst_stream_1_branch_taken; // @ Stream.scala l296
  assign dec_dst_1_instr = dst_stream_1_instr; // @ Stream.scala l296

endmodule

//DecodeComb_1 replaced by DecodeComb
...
module DecodeComb (
  ...
  output     [4:0]    rd_addr,
  output     [63:0]   imm,
  output              micro_op_uop_com_rd_wen,
  output              micro_op_uop_com_src2_is_imm,
  output     [4:0]    micro_op_uop_alu_alu_ctrl_op,
  output              micro_op_uop_alu_alu_is_word,
  output     [3:0]    micro_op_uop_bju_bju_ctrl_op,
  output              micro_op_uop_bju_bju_rd_eq_rs1,
  output              micro_op_uop_bju_bju_rd_is_link,
  output              micro_op_uop_bju_bju_rs1_is_link,
  output     [3:0]    micro_op_uop_bju_exp_ctrl_op,
  output     [11:0]   micro_op_uop_bju_exp_csr_addr,
  output              micro_op_uop_bju_exp_csr_wen,
  output     [3:0]    micro_op_uop_lsu_lsu_ctrl_op,
  output              micro_op_uop_lsu_lsu_is_load,
  output              micro_op_uop_lsu_lsu_is_store,
  output reg [2:0]    exe_sel
);
  localparam AluCtrlEnum_IDLE = 5'd0;
  localparam AluCtrlEnum_ADD = 5'd1;
  localparam AluCtrlEnum_SUB = 5'd2;
  ...
  wire                rd_wen;
  wire                src2_is_imm;
  wire       [4:0]    tmp_micro_op_uop_alu_alu_ctrl_op;
  wire       [3:0]    tmp_micro_op_uop_bju_bju_ctrl_op;
  wire       [3:0]    tmp_micro_op_uop_bju_exp_ctrl_op;
  wire       [3:0]    tmp_micro_op_uop_lsu_lsu_ctrl_op;
  `ifndef SYNTHESIS
  reg [47:0] micro_op_uop_alu_alu_ctrl_op_string;
  reg [39:0] micro_op_uop_bju_bju_ctrl_op_string;
  reg [47:0] micro_op_uop_bju_exp_ctrl_op_string;
  reg [31:0] micro_op_uop_lsu_lsu_ctrl_op_string;
  reg [31:0] exe_sel_string;
  ...
  reg [47:0] tmp_micro_op_uop_alu_alu_ctrl_op_string;
  reg [39:0] tmp_micro_op_uop_bju_bju_ctrl_op_string;
  reg [47:0] tmp_micro_op_uop_bju_exp_ctrl_op_string;
  reg [31:0] tmp_micro_op_uop_lsu_lsu_ctrl_op_string;
  `endif
  ...
  `ifndef SYNTHESIS
  always @(*) begin
    case(micro_op_uop_alu_alu_ctrl_op)
      AluCtrlEnum_IDLE : micro_op_uop_alu_alu_ctrl_op_string = "IDLE  ";
      AluCtrlEnum_ADD : micro_op_uop_alu_alu_ctrl_op_string = "ADD   ";
      AluCtrlEnum_SUB : micro_op_uop_alu_alu_ctrl_op_string = "SUB   ";
      AluCtrlEnum_SLT : micro_op_uop_alu_alu_ctrl_op_string = "SLT   ";
      AluCtrlEnum_SLTU : micro_op_uop_alu_alu_ctrl_op_string = "SLTU  ";
      AluCtrlEnum_XOR_1 : micro_op_uop_alu_alu_ctrl_op_string = "XOR_1 ";
      AluCtrlEnum_SLL_1 : micro_op_uop_alu_alu_ctrl_op_string = "SLL_1 ";
      AluCtrlEnum_SRL_1 : micro_op_uop_alu_alu_ctrl_op_string = "SRL_1 ";
      AluCtrlEnum_SRA_1 : micro_op_uop_alu_alu_ctrl_op_string = "SRA_1 ";
      AluCtrlEnum_AND_1 : micro_op_uop_alu_alu_ctrl_op_string = "AND_1 ";
      AluCtrlEnum_OR_1 : micro_op_uop_alu_alu_ctrl_op_string = "OR_1  ";
      AluCtrlEnum_LUI : micro_op_uop_alu_alu_ctrl_op_string = "LUI   ";
      AluCtrlEnum_MUL : micro_op_uop_alu_alu_ctrl_op_string = "MUL   ";
      AluCtrlEnum_MULH : micro_op_uop_alu_alu_ctrl_op_string = "MULH  ";
      AluCtrlEnum_MULHSU : micro_op_uop_alu_alu_ctrl_op_string = "MULHSU";
      AluCtrlEnum_MULHU : micro_op_uop_alu_alu_ctrl_op_string = "MULHU ";
      AluCtrlEnum_DIV : micro_op_uop_alu_alu_ctrl_op_string = "DIV   ";
      AluCtrlEnum_DIVU : micro_op_uop_alu_alu_ctrl_op_string = "DIVU  ";
      AluCtrlEnum_REM_1 : micro_op_uop_alu_alu_ctrl_op_string = "REM_1 ";
      AluCtrlEnum_REMU : micro_op_uop_alu_alu_ctrl_op_string = "REMU  ";
      AluCtrlEnum_MULW : micro_op_uop_alu_alu_ctrl_op_string = "MULW  ";
      AluCtrlEnum_DIVW : micro_op_uop_alu_alu_ctrl_op_string = "DIVW  ";
      AluCtrlEnum_DIVUW : micro_op_uop_alu_alu_ctrl_op_string = "DIVUW ";
      AluCtrlEnum_REMW : micro_op_uop_alu_alu_ctrl_op_string = "REMW  ";
      AluCtrlEnum_REMUW : micro_op_uop_alu_alu_ctrl_op_string = "REMUW ";
      default : micro_op_uop_alu_alu_ctrl_op_string = "??????";
    endcase
  end
  always @(*) begin
    case(micro_op_uop_bju_bju_ctrl_op)
      BjuCtrlEnum_IDLE : micro_op_uop_bju_bju_ctrl_op_string = "IDLE ";
      BjuCtrlEnum_AUIPC : micro_op_uop_bju_bju_ctrl_op_string = "AUIPC";
      BjuCtrlEnum_JAL : micro_op_uop_bju_bju_ctrl_op_string = "JAL  ";
      BjuCtrlEnum_JALR : micro_op_uop_bju_bju_ctrl_op_string = "JALR ";
      BjuCtrlEnum_BEQ : micro_op_uop_bju_bju_ctrl_op_string = "BEQ  ";
      BjuCtrlEnum_BNE : micro_op_uop_bju_bju_ctrl_op_string = "BNE  ";
      BjuCtrlEnum_BLT : micro_op_uop_bju_bju_ctrl_op_string = "BLT  ";
      BjuCtrlEnum_BGE : micro_op_uop_bju_bju_ctrl_op_string = "BGE  ";
      BjuCtrlEnum_BLTU : micro_op_uop_bju_bju_ctrl_op_string = "BLTU ";
      BjuCtrlEnum_BGEU : micro_op_uop_bju_bju_ctrl_op_string = "BGEU ";
      BjuCtrlEnum_CSR : micro_op_uop_bju_bju_ctrl_op_string = "CSR  ";
      default : micro_op_uop_bju_bju_ctrl_op_string = "?????";
    endcase
  end
  always @(*) begin
    case(micro_op_uop_bju_exp_ctrl_op)
      ExpCtrlEnum_IDLE : micro_op_uop_bju_exp_ctrl_op_string = "IDLE  ";
      ExpCtrlEnum_ECALL : micro_op_uop_bju_exp_ctrl_op_string = "ECALL ";
      ExpCtrlEnum_EBREAK : micro_op_uop_bju_exp_ctrl_op_string = "EBREAK";
      ExpCtrlEnum_MRET : micro_op_uop_bju_exp_ctrl_op_string = "MRET  ";
      ExpCtrlEnum_CSRRW : micro_op_uop_bju_exp_ctrl_op_string = "CSRRW ";
      ExpCtrlEnum_CSRRS : micro_op_uop_bju_exp_ctrl_op_string = "CSRRS ";
      ExpCtrlEnum_CSRRC : micro_op_uop_bju_exp_ctrl_op_string = "CSRRC ";
      ExpCtrlEnum_CSRRWI : micro_op_uop_bju_exp_ctrl_op_string = "CSRRWI";
      ExpCtrlEnum_CSRRSI : micro_op_uop_bju_exp_ctrl_op_string = "CSRRSI";
      ExpCtrlEnum_CSRRCI : micro_op_uop_bju_exp_ctrl_op_string = "CSRRCI";
      default : micro_op_uop_bju_exp_ctrl_op_string = "??????";
    endcase
  end
  always @(*) begin
    case(micro_op_uop_lsu_lsu_ctrl_op)
      LsuCtrlEnum_IDLE : micro_op_uop_lsu_lsu_ctrl_op_string = "IDLE";
      LsuCtrlEnum_LB : micro_op_uop_lsu_lsu_ctrl_op_string = "LB  ";
      LsuCtrlEnum_LBU : micro_op_uop_lsu_lsu_ctrl_op_string = "LBU ";
      LsuCtrlEnum_LH : micro_op_uop_lsu_lsu_ctrl_op_string = "LH  ";
      LsuCtrlEnum_LHU : micro_op_uop_lsu_lsu_ctrl_op_string = "LHU ";
      LsuCtrlEnum_LW : micro_op_uop_lsu_lsu_ctrl_op_string = "LW  ";
      LsuCtrlEnum_LWU : micro_op_uop_lsu_lsu_ctrl_op_string = "LWU ";
      LsuCtrlEnum_LD : micro_op_uop_lsu_lsu_ctrl_op_string = "LD  ";
      LsuCtrlEnum_SB : micro_op_uop_lsu_lsu_ctrl_op_string = "SB  ";
      LsuCtrlEnum_SH : micro_op_uop_lsu_lsu_ctrl_op_string = "SH  ";
      LsuCtrlEnum_SW : micro_op_uop_lsu_lsu_ctrl_op_string = "SW  ";
      LsuCtrlEnum_SD : micro_op_uop_lsu_lsu_ctrl_op_string = "SD  ";
      default : micro_op_uop_lsu_lsu_ctrl_op_string = "????";
    endcase
  end
  always @(*) begin
    case(exe_sel)
      ExeSelEnum_IDLE : exe_sel_string = "IDLE";
      ExeSelEnum_ALU : exe_sel_string = "ALU ";
      ExeSelEnum_BJU : exe_sel_string = "BJU ";
      ExeSelEnum_LSU : exe_sel_string = "LSU ";
      ExeSelEnum_DIV : exe_sel_string = "DIV ";
      default : exe_sel_string = "????";
    endcase
  end
  always @(*) begin
  ...
  always @(*) begin
    case(tmp_micro_op_uop_alu_alu_ctrl_op)
      AluCtrlEnum_IDLE : tmp_micro_op_uop_alu_alu_ctrl_op_string = "IDLE  ";
      AluCtrlEnum_ADD : tmp_micro_op_uop_alu_alu_ctrl_op_string = "ADD   ";
      AluCtrlEnum_SUB : tmp_micro_op_uop_alu_alu_ctrl_op_string = "SUB   ";
      AluCtrlEnum_SLT : tmp_micro_op_uop_alu_alu_ctrl_op_string = "SLT   ";
      AluCtrlEnum_SLTU : tmp_micro_op_uop_alu_alu_ctrl_op_string = "SLTU  ";
      AluCtrlEnum_XOR_1 : tmp_micro_op_uop_alu_alu_ctrl_op_string = "XOR_1 ";
      AluCtrlEnum_SLL_1 : tmp_micro_op_uop_alu_alu_ctrl_op_string = "SLL_1 ";
      AluCtrlEnum_SRL_1 : tmp_micro_op_uop_alu_alu_ctrl_op_string = "SRL_1 ";
      AluCtrlEnum_SRA_1 : tmp_micro_op_uop_alu_alu_ctrl_op_string = "SRA_1 ";
      AluCtrlEnum_AND_1 : tmp_micro_op_uop_alu_alu_ctrl_op_string = "AND_1 ";
      AluCtrlEnum_OR_1 : tmp_micro_op_uop_alu_alu_ctrl_op_string = "OR_1  ";
      AluCtrlEnum_LUI : tmp_micro_op_uop_alu_alu_ctrl_op_string = "LUI   ";
      AluCtrlEnum_MUL : tmp_micro_op_uop_alu_alu_ctrl_op_string = "MUL   ";
      AluCtrlEnum_MULH : tmp_micro_op_uop_alu_alu_ctrl_op_string = "MULH  ";
      AluCtrlEnum_MULHSU : tmp_micro_op_uop_alu_alu_ctrl_op_string = "MULHSU";
      AluCtrlEnum_MULHU : tmp_micro_op_uop_alu_alu_ctrl_op_string = "MULHU ";
      AluCtrlEnum_DIV : tmp_micro_op_uop_alu_alu_ctrl_op_string = "DIV   ";
      AluCtrlEnum_DIVU : tmp_micro_op_uop_alu_alu_ctrl_op_string = "DIVU  ";
      AluCtrlEnum_REM_1 : tmp_micro_op_uop_alu_alu_ctrl_op_string = "REM_1 ";
      AluCtrlEnum_REMU : tmp_micro_op_uop_alu_alu_ctrl_op_string = "REMU  ";
      AluCtrlEnum_MULW : tmp_micro_op_uop_alu_alu_ctrl_op_string = "MULW  ";
      AluCtrlEnum_DIVW : tmp_micro_op_uop_alu_alu_ctrl_op_string = "DIVW  ";
      AluCtrlEnum_DIVUW : tmp_micro_op_uop_alu_alu_ctrl_op_string = "DIVUW ";
      AluCtrlEnum_REMW : tmp_micro_op_uop_alu_alu_ctrl_op_string = "REMW  ";
      AluCtrlEnum_REMUW : tmp_micro_op_uop_alu_alu_ctrl_op_string = "REMUW ";
      default : tmp_micro_op_uop_alu_alu_ctrl_op_string = "??????";
    endcase
  end
  always @(*) begin
    case(tmp_micro_op_uop_bju_bju_ctrl_op)
      BjuCtrlEnum_IDLE : tmp_micro_op_uop_bju_bju_ctrl_op_string = "IDLE ";
      BjuCtrlEnum_AUIPC : tmp_micro_op_uop_bju_bju_ctrl_op_string = "AUIPC";
      BjuCtrlEnum_JAL : tmp_micro_op_uop_bju_bju_ctrl_op_string = "JAL  ";
      BjuCtrlEnum_JALR : tmp_micro_op_uop_bju_bju_ctrl_op_string = "JALR ";
      BjuCtrlEnum_BEQ : tmp_micro_op_uop_bju_bju_ctrl_op_string = "BEQ  ";
      BjuCtrlEnum_BNE : tmp_micro_op_uop_bju_bju_ctrl_op_string = "BNE  ";
      BjuCtrlEnum_BLT : tmp_micro_op_uop_bju_bju_ctrl_op_string = "BLT  ";
      BjuCtrlEnum_BGE : tmp_micro_op_uop_bju_bju_ctrl_op_string = "BGE  ";
      BjuCtrlEnum_BLTU : tmp_micro_op_uop_bju_bju_ctrl_op_string = "BLTU ";
      BjuCtrlEnum_BGEU : tmp_micro_op_uop_bju_bju_ctrl_op_string = "BGEU ";
      BjuCtrlEnum_CSR : tmp_micro_op_uop_bju_bju_ctrl_op_string = "CSR  ";
      default : tmp_micro_op_uop_bju_bju_ctrl_op_string = "?????";
    endcase
  end
  always @(*) begin
    case(tmp_micro_op_uop_bju_exp_ctrl_op)
      ExpCtrlEnum_IDLE : tmp_micro_op_uop_bju_exp_ctrl_op_string = "IDLE  ";
      ExpCtrlEnum_ECALL : tmp_micro_op_uop_bju_exp_ctrl_op_string = "ECALL ";
      ExpCtrlEnum_EBREAK : tmp_micro_op_uop_bju_exp_ctrl_op_string = "EBREAK";
      ExpCtrlEnum_MRET : tmp_micro_op_uop_bju_exp_ctrl_op_string = "MRET  ";
      ExpCtrlEnum_CSRRW : tmp_micro_op_uop_bju_exp_ctrl_op_string = "CSRRW ";
      ExpCtrlEnum_CSRRS : tmp_micro_op_uop_bju_exp_ctrl_op_string = "CSRRS ";
      ExpCtrlEnum_CSRRC : tmp_micro_op_uop_bju_exp_ctrl_op_string = "CSRRC ";
      ExpCtrlEnum_CSRRWI : tmp_micro_op_uop_bju_exp_ctrl_op_string = "CSRRWI";
      ExpCtrlEnum_CSRRSI : tmp_micro_op_uop_bju_exp_ctrl_op_string = "CSRRSI";
      ExpCtrlEnum_CSRRCI : tmp_micro_op_uop_bju_exp_ctrl_op_string = "CSRRCI";
      default : tmp_micro_op_uop_bju_exp_ctrl_op_string = "??????";
    endcase
  end
  always @(*) begin
    case(tmp_micro_op_uop_lsu_lsu_ctrl_op)
      LsuCtrlEnum_IDLE : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "IDLE";
      LsuCtrlEnum_LB : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "LB  ";
      LsuCtrlEnum_LBU : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "LBU ";
      LsuCtrlEnum_LH : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "LH  ";
      LsuCtrlEnum_LHU : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "LHU ";
      LsuCtrlEnum_LW : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "LW  ";
      LsuCtrlEnum_LWU : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "LWU ";
      LsuCtrlEnum_LD : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "LD  ";
      LsuCtrlEnum_SB : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "SB  ";
      LsuCtrlEnum_SH : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "SH  ";
      LsuCtrlEnum_SW : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "SW  ";
      LsuCtrlEnum_SD : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "SD  ";
      default : tmp_micro_op_uop_lsu_lsu_ctrl_op_string = "????";
    endcase
  end
  `endif
  ...
  assign imm = (((((tmp_imm_6 | tmp_imm_47) | (tmp_imm_88 & tmp_imm_89)) | (imm_data[255 : 192] & {tmp_imm_130,tmp_imm_131})) | (imm_data[319 : 256] & {tmp_imm_4,{tmp_imm_172,tmp_imm_173}})) | (imm_data[383 : 320] & {tmp_imm_5,{tmp_imm_5,{tmp_imm_214,tmp_imm_215}}})); // @ Decode.scala l174
  ...
  assign rs1_addr = rs1; // @ Decode.scala l223
  assign rs2_addr = rs2; // @ Decode.scala l224
  assign rd_addr = rd; // @ Decode.scala l225
  assign rd_wen = ((((((! (instr[6 : 0] == 7'h23)) && (! (instr[6 : 0] == 7'h63))) && (! ebreak)) && (! ecall)) && (! mret)) && (! op_is_fence)); // @ BaseType.scala l305
  assign src2_is_imm = (((((((instr[6 : 0] == 7'h13) || (instr[6 : 0] == 7'h1b)) || (instr[6 : 0] == 7'h03)) || (instr[6 : 0] == 7'h67)) || (instr[6 : 0] == 7'h23)) || ((instr[6 : 0] == 7'h37) || (instr[6 : 0] == 7'h17))) || (instr[6 : 0] == 7'h6f)); // @ BaseType.scala l305
  assign micro_op_uop_com_rd_wen = rd_wen; // @ Decode.scala l240
  assign micro_op_uop_com_src2_is_imm = src2_is_imm; // @ Decode.scala l241
  assign tmp_micro_op_uop_alu_alu_ctrl_op = alu_ctrl_op; // @ Enum.scala l189
  assign micro_op_uop_alu_alu_ctrl_op = tmp_micro_op_uop_alu_alu_ctrl_op; // @ Enum.scala l191
  assign micro_op_uop_alu_alu_is_word = (op_is_word || op_is_wordi); // @ Decode.scala l244
  assign tmp_micro_op_uop_bju_bju_ctrl_op = bju_ctrl_op; // @ Enum.scala l189
  assign micro_op_uop_bju_bju_ctrl_op = tmp_micro_op_uop_bju_bju_ctrl_op; // @ Enum.scala l191
  assign micro_op_uop_bju_bju_rd_eq_rs1 = (rd == rs1); // @ Decode.scala l247
  assign micro_op_uop_bju_bju_rd_is_link = ((rd == 5'h0) || (rd == 5'h05)); // @ Decode.scala l248
  assign micro_op_uop_bju_bju_rs1_is_link = ((rs1 == 5'h0) || (rs1 == 5'h05)); // @ Decode.scala l249
  assign tmp_micro_op_uop_bju_exp_ctrl_op = exp_ctrl_op; // @ Enum.scala l189
  assign micro_op_uop_bju_exp_ctrl_op = tmp_micro_op_uop_bju_exp_ctrl_op; // @ Enum.scala l191
  assign micro_op_uop_bju_exp_csr_addr = csr; // @ Decode.scala l251
  assign micro_op_uop_bju_exp_csr_wen = ((csrrw || csrrs) || csrrc); // @ Decode.scala l252
  assign tmp_micro_op_uop_lsu_lsu_ctrl_op = lsu_ctrl_op; // @ Enum.scala l189
  assign micro_op_uop_lsu_lsu_ctrl_op = tmp_micro_op_uop_lsu_lsu_ctrl_op; // @ Enum.scala l191
  assign micro_op_uop_lsu_lsu_is_load = op_is_load; // @ Decode.scala l255
  assign micro_op_uop_lsu_lsu_is_store = op_is_store; // @ Decode.scala l256
  always @(*) begin
    if((op_is_load || op_is_store)) begin
      exe_sel = ExeSelEnum_LSU; // @ Enum.scala l151
    end else begin
      if((((((((div || divu) || rem_1) || remu) || divw) || divuw) || remw) || remuw)) begin
        exe_sel = ExeSelEnum_DIV; // @ Enum.scala l151
      end else begin
        if(((((op_is_imm || op_is_alu) || op_is_lui) || op_is_word) || op_is_wordi)) begin
          exe_sel = ExeSelEnum_ALU; // @ Enum.scala l151
        end else begin
          if(((((op_is_jal || op_is_jalr) || op_is_branch) || op_is_auipc) || op_is_sys)) begin
            exe_sel = ExeSelEnum_BJU; // @ Enum.scala l151
          end else begin
            exe_sel = ExeSelEnum_IDLE; // @ Enum.scala l151
          end
        end
      end
    end
