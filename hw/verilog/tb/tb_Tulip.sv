...
assign wb_valid[0] = tb_Tulip.u_Tulip.commit_1.ret_dst_0_valid;
assign wb_valid[1] = tb_Tulip.u_Tulip.commit_1.ret_dst_1_valid;
assign wb_pc[0]    = tb_Tulip.u_Tulip.commit_1.ret_dst_0_pc[31:0];
assign wb_pc[1]    = tb_Tulip.u_Tulip.commit_1.ret_dst_1_pc[31:0];
assign wb_inst[0]  = tb_Tulip.u_Tulip.commit_1.ret_dst_0_instr[31:0];
assign wb_inst[1]  = tb_Tulip.u_Tulip.commit_1.ret_dst_1_instr[31:0];
assign wb_wen[0]   = tb_Tulip.u_Tulip.commit_1.ret_dst_0_rd_wen;
assign wb_wen[1]   = tb_Tulip.u_Tulip.commit_1.ret_dst_1_rd_wen;
assign wb_addr[0]  = tb_Tulip.u_Tulip.commit_1.ret_dst_0_rd_addr;
assign wb_addr[1]  = tb_Tulip.u_Tulip.commit_1.ret_dst_1_rd_addr;
assign wb_data[0]  = tb_Tulip.u_Tulip.commit_1.ret_dst_0_rd_data;
assign wb_data[1]  = tb_Tulip.u_Tulip.commit_1.ret_dst_1_rd_data;
