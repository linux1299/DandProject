...
logic          retire_ready_0 = 1        ;
logic          retire_ready_1 = 1        ;
...
// 	$display("\n================== Time:%d, Dump Start ================\n",$time);
//   $fsdbDumpon;
// 	$fsdbDumpfile("./tb_BiotCore.fsdb");
// 	$fsdbDumpvars(0, "tb_BiotCore", "+mda");
// end
...
wire        wb_valid [1:0];
wire [31:0] wb_pc  [1:0];
wire [31:0] wb_inst[1:0];
wire        wb_wen [1:0];
wire [4:0]  wb_addr[1:0];
wire [63:0] wb_data[1:0];

assign wb_valid[0] = tb_BiotCore.u_BiotCore.commit_1.retire_0_valid;
assign wb_valid[1] = tb_BiotCore.u_BiotCore.commit_1.retire_1_valid;
assign wb_pc[0]    = tb_BiotCore.u_BiotCore.commit_1.retire_0_pc[31:0];
assign wb_pc[1]    = tb_BiotCore.u_BiotCore.commit_1.retire_1_pc[31:0];
assign wb_inst[0]  = tb_BiotCore.u_BiotCore.commit_1.retire_0_instr[31:0];
assign wb_inst[1]  = tb_BiotCore.u_BiotCore.commit_1.retire_1_instr[31:0];
assign wb_wen[0]   = tb_BiotCore.u_BiotCore.commit_1.retire_0_rd_wen;
assign wb_wen[1]   = tb_BiotCore.u_BiotCore.commit_1.retire_1_rd_wen;
assign wb_addr[0]  = tb_BiotCore.u_BiotCore.commit_1.retire_0_rd_addr;
assign wb_addr[1]  = tb_BiotCore.u_BiotCore.commit_1.retire_1_rd_addr;
