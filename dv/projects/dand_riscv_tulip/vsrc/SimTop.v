...
initial begin
  ...
  for (k = 0; k < 4096; k = k + 1) begin
    SimTop.u_Tulip.dcache.sram_5.mem_symbol0[k] = dram_tmp[k*4 + 0][7:0];
    SimTop.u_Tulip.dcache.sram_5.mem_symbol1[k] = dram_tmp[k*4 + 1][7:0];
    SimTop.u_Tulip.dcache.sram_5.mem_symbol2[k] = dram_tmp[k*4 + 2][7:0];
    SimTop.u_Tulip.dcache.sram_5.mem_symbol3[k] = dram_tmp[k*4 + 3][7:0];
    SimTop.u_Tulip.dcache.sram_5.mem_symbol4[k] = dram_tmp[k*4 + 4][7:0];
    SimTop.u_Tulip.dcache.sram_5.mem_symbol5[k] = dram_tmp[k*4 + 5][7:0];
    SimTop.u_Tulip.dcache.sram_5.mem_symbol6[k] = dram_tmp[k*4 + 6][7:0];
    SimTop.u_Tulip.dcache.sram_5.mem_symbol7[k] = dram_tmp[k*4 + 7][7:0];
  end
end
...
fifo_2write#(
    ...
    .write_0    ( SimTop.u_Tulip.commit_1.retire_0_valid && SimTop.u_Tulip.commit_1.retire_0_ready   ),
    .write_1    ( SimTop.u_Tulip.commit_1.retire_1_valid && SimTop.u_Tulip.commit_1.retire_1_ready   ),
    .fifo_in_0  ( {SimTop.u_Tulip.commit_1.retire_0_rd_wen, SimTop.u_Tulip.commit_1.retire_0_pc, SimTop.u_Tulip.commit_1.retire_0_instr, SimTop.u_Tulip.commit_1.retire_0_rd_addr, SimTop.u_Tulip.commit_1.retire_0_rd_data}  ),
    .fifo_in_1  ( {SimTop.u_Tulip.commit_1.retire_1_rd_wen, SimTop.u_Tulip.commit_1.retire_1_pc, SimTop.u_Tulip.commit_1.retire_1_instr, SimTop.u_Tulip.commit_1.retire_1_rd_addr, SimTop.u_Tulip.commit_1.retire_1_rd_data}  ),
